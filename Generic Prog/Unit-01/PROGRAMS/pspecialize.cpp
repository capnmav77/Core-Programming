...
int main()
{
	...
	StaticArray<char, 14> char14{}; // the type is specialized, but the size is not
    ...
    StaticArray<int , 12 > int12{}; // the type is specialized, but the size is not
    ...
    std::copy_n(ar12 , 12 , int12.getArray());
