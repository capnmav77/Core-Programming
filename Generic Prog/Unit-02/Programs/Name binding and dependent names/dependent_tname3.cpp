...
struct parser
{
	parser* p1; // parser is the CI // CI = class identifier
	parser<T>* p2; // parser<T> is the CI
	::parser<T>* p3; // ::parser<T> is the CI // :: is the global scope operator which is used to access the global scope of a namespace
